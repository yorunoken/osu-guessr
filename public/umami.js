!(function () {
    ...
    ((t) => {
        ...
        const m = "data-",
            ...
            L = () => ({ website: g, hostname: c, screen: j, language: r, title: J, url: C, referrer: I, tag: b || void 0 }),
            $ = (t, e, a) => {
            ...
            U = async (t, e = "event") => {
                ...
                try {
                    const r = await fetch(A, { method: "POST", body: JSON.stringify({ type: e, payload: t }), headers: a }),
                        n = await r.json();
            ...
            D = (t, e) => U("string" == typeof t ? { ...L(), name: t, data: "object" == typeof e ? e : void 0 } : "object" == typeof t ? t : "function" == typeof t ? t(L()) : L()),
